...
func Cursor(config options.PxCanvasConfig, brush options.BrushType, ev *desktop.MouseEvent, x int, y int) []fyne.CanvasObject {
...
func TryBrush(appState *options.State, canvas options.Brushable, ev *desktop.MouseEvent) bool {
...
func TryPaintPixel(appState *options.State, canvas options.Brushable, ev *desktop.MouseEvent) bool {
